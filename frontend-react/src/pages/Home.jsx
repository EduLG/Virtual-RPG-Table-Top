...
const Home = () => {
  return (
    <div className="flex min-h-screen bg-[#2b1e14] h-screen">
      ...
      <main
        className="grid grid-cols-[1fr_3fr_1fr] p-6 w-full h-full bg-cover bg-center"
        style={{ backgroundImage: `url(${bgImage})` }}
      >
        <div className="col-start-2 grid grid-cols-2 grid-rows-2 gap-6 h-full">
          {[1, 2, 3, 4].map((card) => (
            <div
              key={card}
